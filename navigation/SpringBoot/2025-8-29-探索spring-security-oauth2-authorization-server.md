...
- 向`authenticationProviders`注册，并返回`OAuth2AccessTokenAuthenticationToken`
  ...
  5. **OAuth2TokenExchangeAuthenticationProvider** `AuthorizationGrantType=urn:ietf:params:oauth:grant-type:token-exchange`
     ...
     >
     > ![authorization_code](https://raw.githubusercontent.com/PhotonAlpha/blogs/master/images/authorization_code_flow.png)
     >
     > 这是令牌交换流程：
     >
     > ![authorization_code](https://raw.githubusercontent.com/PhotonAlpha/blogs/master/images/exchange_code_flow.png)
     >
     > #### 重定向
     >
...
![authorization_code_flow.png](https://raw.githubusercontent.com/PhotonAlpha/blogs/master/images/authorization_code_flow.png)

这是令牌交换流程：

![exchange_code_flow](https://raw.githubusercontent.com/PhotonAlpha/blogs/master/images/exchange_code_flow.png)
...
![authorization_code_intercept_attack](https://raw.githubusercontent.com/PhotonAlpha/blogs/master/images/authorization_code_intercept_attack.png)
...
![authorization_code_intercept_attack_2](https://raw.githubusercontent.com/PhotonAlpha/blogs/master/images/authorization_code_intercept_attack_2.png)
